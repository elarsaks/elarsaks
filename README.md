...
|---------|-------------|-----------|-------------|-------|
| **𝗚𝗼𝗿𝗶𝗹𝗹𝗮 𝗟𝗮𝗯𝘀** | This is an NFT marketplace that I am building, just to expand and showcase my skills. Based on the current idea, it will be built using Next & Node.js written in TypeScript and running on AWS EC2. | [Live](gorilla-labs.com) | [Source Code](https://github.com/elarsaks/gorilla-labs) | <img src="https://github.com/elarsaks/gorilla-labs/blob/main/client/public/assets/logo.png" width="100"> |
